...
class Application:
    ...
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title("Real Time Sign Language Recognition System")
        ...
        self.T.config(text="Real Time Sign Language Recognition System", font=(
            "Courier", 30, "bold"))
    ...
    def video_loop(self):
        try:
            ...
            if hands:
                ...
                white = cv2.imread(
                    "D:\BTECH CLASSES\7)SEVENTH SEMESTER\sc project\Sign-Language-To-Text-and-Speech-Conversion\white.jpg")
                # img_final=img_final1=img_final2=0
